...
<main id="tt-pageContent">
    <div class="tt-custom-mobile-indent qcontainer">
        <div class="tt-categories-title">
            ...
            <div class="tt-search">
                <form action="<?php echo JRoute::_('index.php?option=com_questions&view=categories&layout=search'); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
                    <div class="search-form">
                        <input type="text" name="searchstr" class="tt-search__input" placeholder="Search Categories">
                        <button class="tt-search__btn" type="submit" onclick="Joomla.submitbutton('form.save')"><img src="components/com_questions/media/images/search-small.png" /></button>
                    </div>
        ...
        <div class="tt-categories-list">
            <div class="row">
				...
				foreach($this->getSearch as $category) {
